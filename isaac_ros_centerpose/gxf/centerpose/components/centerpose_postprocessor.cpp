...
#include "centerpose_postprocessor.hpp"
#include <math.h>
...
#include "centerpose_detection.hpp"
#include "cuboid3d.hpp"
#include "cuboid_pnp_solver.hpp"
#include "cuda.h"
...
gxf::Expected<void> ToTensor(
  ...
  if (eigen_type.size() == 0) {
    return tensor->reshape<T>(gxf::Shape{0, 0, 0}, storage_type, allocator);
  }
  return tensor
      ->reshape<T>(
          gxf::Shape{
